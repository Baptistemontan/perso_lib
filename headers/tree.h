...
typedef void (*tree_print_fn)(const void* value);
...
// give to the print fonction the value of every node in the preorder
void tree_printPre(const tree_node* root, tree_print_fn print_fn);

// give to the print fonction the value of every node in the inorder
void tree_printIn(const tree_node* root, tree_print_fn print_fn);

// give to the print fonction the value of every node in the postorder
void tree_printPost(const tree_node* root, tree_print_fn print_fn);

// return 0 if the tree is not balanced, return an int > 0 if balanced 
...
// give to the print fonction the value of every node in the level order
